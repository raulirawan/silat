                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('undangan.store') }}" method="post" novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tanggal" spellcheck="true" class="form-control" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nip" spellcheck="true" class="form-control" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lampiran" spellcheck="true" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label class="control-label mb-1">Hal</label>
                                    <input type="text" name="hal" spellcheck="true" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label class="control-label mb-1">Hari</label>
                                    <input type="text" name="hari" spellcheck="true" class="form-control" required>
                                </div>
                                <div class="form-group">
